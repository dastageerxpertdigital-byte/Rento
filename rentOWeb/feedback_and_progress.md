# Admin Portal Refinement - Feedback and Progress
...
- **Status:** **Resolved.**
  ...
  - Functionality like "Broadcast Message" has been moved to its proper component (`DashboardView`) where it is fully wired up.
...
- **Status:** **Resolved.**
  - Created a standalone `NotificationsView.tsx` screen, added to the sidebar menu. It now includes a modal option to send a custom push notification to specific users based on UID.
